...
#SBATCH --gres=gpu:rtx8000:1 #gpu:l40s:1 #gpu:h100:1 #gpu:rtx8000:1 #gpu:a40:3 #gpu:rtx8000:3 #gpu:l40s:4  #gpu:a40:3  #gpu:h100:2  #                           # GPU request
#SBATCH --job-name=run_metric_8th                      # Job name
