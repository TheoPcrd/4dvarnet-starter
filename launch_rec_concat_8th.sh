...
#SBATCH --gres=gpu:h100:1 #gpu:l40s:4 #gpu:h100:1 #gpu:rtx8000:1 #gpu:a40:3 #gpu:rtx8000:3 #gpu:l40s:4  #gpu:a40:3  #gpu:h100:2  #                           # GPU request
...
HYDRA_FULL_ERROR=1 srun python main.py xp='ose_pipeline_multivar_15m_unet_8th' +params='ose_pipeline_1y_1'

HYDRA_FULL_ERROR=1 srun python main.py xp='ose_pipeline_multivar_15m_unet_8th' +params='ose_pipeline_1y_2'

# Chemin vers votre fichier YAML
YAML_FILE="/Odyssey/private/t22picar/multivar_uv/config/xp/ose_pipeline_multivar_15m_unet_8th.yaml"
