...
#SBATCH --gres=gpu:rtx8000:1 #gpu:a40:3 #gpu:l40s:4                          # GPU request
#SBATCH --job-name=rmse_glob_sst                       # Job name
...
xp_name="unet_uv_aoml_15m_10y_11d_bathy_sst_mae_duacs_RonanUnet"
