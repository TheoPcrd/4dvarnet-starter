...
#SBATCH --job-name=multivar_drift_4th_lat                      # Job name
#SBATCH --cpus-per-gpu=12    # 12 CPUs for each GPU
#SBATCH --output=log/job_%j.log # Standard output and error log (%j for jobid)
#SBATCH --mem=400G #200G #180G #200G # #200G #180G #250G #480G #180G #300G #180G #480G #180G #200G #480G
...
#xp_name='unet_uv_glorys_15m_10y_wind_11d_lat'
