...
class StandardBlock(nn.Module):
    def __init__(self, in_channels, out_channels, mid_channels=None,
                 kernel_size=3, dilation=1, dropout_prob=0.2):
        super().__init__()
        ...
        self.double_conv = nn.Sequential(
            ...
            nn.Dropout2d(dropout_prob),  # Ajout du dropout
            nn.Conv2d(
...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, mid_channels=None,
                 kernel_size=3, sf=1, dropout_prob=0.2):
        super().__init__()
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, block, bilinear=True, dropout_prob=0.2, **kwargs):
        super().__init__()
        if bilinear:
            self.up = nn.Upsample(
        ...
        self.dropout = nn.Dropout2d(dropout_prob)  # Ajout du dropout
