...
#https://github.com/JenkinsJR/UncertainDrift/blob/main/core/model/UNet/network.py

class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True, block=StandardBlock,
                 add_input=False):
        super(UNet, self).__init__()
        #self.block = StandardBlock
