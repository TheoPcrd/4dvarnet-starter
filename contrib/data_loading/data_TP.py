...
def open_multivar_datasets(vars_info,
    ...
    if full_time_domain['test']['time'].stop > full_time_domain['train']['time'].stop:
        print(f"domain from {full_time_domain['train']['time'].start} to {full_time_domain['test']['time'].stop }")
        domain['time'] = slice(full_time_domain['train']['time'].start, full_time_domain['test']['time'].stop)
        mask_train = False
    else: 
        print(f"domain from {full_time_domain['train']['time'].start} to {full_time_domain['train']['time'].stop}")
        domain['time'] = slice(full_time_domain['train']['time'].start, full_time_domain['train']['time'].stop)
        mask_train = True
