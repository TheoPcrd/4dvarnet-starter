...
def open_var_dataset(var_path, var, var_name, domain, drop_depth, fill_nan=None, mask_path=None,offset=None):
    """
    ...
    if offset is not None:
        var_dataset[var] = var_dataset[var] + offset
...
def open_multivar_datasets(vars_info,
    ...
    for var, var_info in vars_info.items():
        ...
        if var_mask_path is not None:
            var_dataset = open_var_dataset(var_path, var, var_info.var_name, domain, drop_depth, fill_nan=fill_nan, mask_path=var_mask_path,offset=offset)
        ...
        var_dataset = open_var_dataset(var_path, var, var_info.var_name, domain, drop_depth, fill_nan=fill_nan,offset=offset)
